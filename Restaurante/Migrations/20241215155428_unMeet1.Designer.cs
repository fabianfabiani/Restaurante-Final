...
namespace Restaurante.Migrations
{
    ...
    [Migration("20241215155428_unMeet1")]
    partial class unMeet1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Restaurante.Entities.Encuesta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Restaurante.Entities.Factura", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Restaurante.Entities.Pedido", b =>
                {
                    ...
                    b.Property<int>("EmpleadoModificadorId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Restaurante.Entities.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Restaurante.Entities.Encuesta", b =>
                {
                    ...
                    b.HasOne("Restaurante.Entities.Mesa", null)
                        .WithMany("Encuestas")
                        .HasForeignKey("MesaId");
